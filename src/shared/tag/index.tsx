      ...
      className={cn(
        {
          ...
          "py-1 px-4": true,
          shadow: true,
          "bg-white text-green-600 font-bold  dark:bg-neutral-800  dark:border-neutral-800 group-hover:text-green-700 group-hover:bg-white/85 dark:group-hover:text-green-500 dark:group-hover:bg-neutral-900/70":
          ...
          "text-gray-500/70 dark:text-gray-500 dark:group-hover:text-gray-400 group-hover:text-gray-500 inline-block dark:border-black":
